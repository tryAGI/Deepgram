...
namespace Deepgram.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "Deepgram.CLI";
    private const string UserSecretApiKeyName = "DEEPGRAM_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"DEEPGRAM_API_KEY"];
    private const string CredentialFileDirectoryName = ".deepgram";

    public static async global::System.Threading.Tasks.Task<global::Deepgram.DeepgramClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Deepgram.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Deepgram.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Deepgram.DeepgramClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Deepgram.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Deepgram.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Deepgram.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Deepgram.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("DEEPGRAM_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Deepgram.ApiException exception)
    {
        var builder = new StringBuilder();
