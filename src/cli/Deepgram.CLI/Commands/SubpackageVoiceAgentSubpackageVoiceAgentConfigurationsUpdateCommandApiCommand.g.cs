...
internal static partial class SubpackageVoiceAgentSubpackageVoiceAgentConfigurationsUpdateCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.SubpackageVoiceAgentSubpackageVoiceAgentConfigurations.UpdateAsync(
                                    projectId: projectId,
                                    agentId: agentId,
                                    metadata: metadata,
