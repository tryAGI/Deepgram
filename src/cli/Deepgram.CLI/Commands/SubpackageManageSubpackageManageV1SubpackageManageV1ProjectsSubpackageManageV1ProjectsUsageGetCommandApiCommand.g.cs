...
internal static partial class SubpackageManageSubpackageManageV1SubpackageManageV1ProjectsSubpackageManageV1ProjectsUsageGetCommandApiCommand
{
    ...
    private static Option<global::Deepgram.V1ProjectsProjectIdUsageGetParametersDeployment?> Deployment { get; } = new(
        name: @"--deployment")
    {
    ...
    private static Option<global::Deepgram.V1ProjectsProjectIdUsageGetParametersEndpoint?> Endpoint { get; } = new(
        name: @"--endpoint")
    {
    ...
    private static Option<global::Deepgram.V1ProjectsProjectIdUsageGetParametersMethod?> Method { get; } = new(
        name: @"--method")
    {
    ...
    private static Option<bool?> Version { get; } = CliRuntime.CreateNullableBoolOption(
        ...
        description: @"Filter for requests where version was used");
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Deepgram.UsageV1Response value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Deepgram.UsageV1Response value, ref string? text);
                    static partial void CustomizeResponseFormatHints(Dictionary<string, CliFormatHint> hints);


    public static Command Create()
    {
        var command = new Command(@"get", @"Get Project Usage
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.SubpackageManageSubpackageManageV1SubpackageManageV1ProjectsSubpackageManageV1ProjectsUsage.GetAsync(
                                    projectId: projectId,
                                    start: start,
                                    end: end,
                                    accessor: accessor,
