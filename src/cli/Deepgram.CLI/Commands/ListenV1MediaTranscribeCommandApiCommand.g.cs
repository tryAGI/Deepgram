...
internal static partial class ListenV1MediaTranscribeCommandApiCommand
{
    ...
    private static Option<global::System.Collections.Generic.IList<string>?> Keyterm { get; } = new(
        name: @"--keyterm")
    {
        Description = @"Key term prompting improves recognition of specialized terminology and brands. Only compatible with Nova-3.
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ListenV1Media.TranscribeAsync(
                                    url: url,
                                    callback: callback,
