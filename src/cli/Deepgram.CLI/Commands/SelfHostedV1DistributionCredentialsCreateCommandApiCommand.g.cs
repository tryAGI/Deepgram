...
internal static partial class SelfHostedV1DistributionCredentialsCreateCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.SelfHostedV1DistributionCredentials.CreateAsync(
                                    projectId: projectId,
                                    scopes: scopes,
                                    provider: provider,
                                    comment: comment,
