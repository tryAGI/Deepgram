...
internal static partial class SubpackageVoiceAgentSubpackageVoiceAgentVariablesCreateCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.SubpackageVoiceAgentSubpackageVoiceAgentVariables.CreateAsync(
                                    projectId: projectId,
                                    key: key,
                                    value: value,
