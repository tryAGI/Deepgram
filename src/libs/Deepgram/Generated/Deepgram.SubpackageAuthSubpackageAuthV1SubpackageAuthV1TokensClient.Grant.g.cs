...
namespace Deepgram
{
    public partial class SubpackageAuthSubpackageAuthV1SubpackageAuthV1TokensClient
    {

        private static readonly global::Deepgram.AutoSDKServer[] s_GrantServers = new global::Deepgram.AutoSDKServer[]
        ...
        private static readonly global::Deepgram.EndPointSecurityRequirement s_GrantSecurityRequirement0 =
        ...
        private static readonly global::Deepgram.EndPointSecurityRequirement[] s_GrantSecurityRequirements =
            new global::Deepgram.EndPointSecurityRequirement[]
            {                s_GrantSecurityRequirement0,
            };
        partial void PrepareGrantArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Deepgram.GrantV1Request request);
        partial void PrepareGrantRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Deepgram.GrantV1Request request);
        partial void ProcessGrantResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGrantResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Deepgram.GrantV1Response> GrantAsync(

            global::Deepgram.GrantV1Request request,
            global::Deepgram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GrantAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Deepgram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Deepgram.AutoSDKHttpResponse<global::Deepgram.GrantV1Response>> GrantAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Deepgram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GrantSecurityRequirements,
                operationName: "GrantAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Deepgram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Deepgram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "Grant",
                                methodName: "GrantAsync",
                                pathTemplate: "\"/v1/auth/grant\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Deepgram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Deepgram.GrantV1Response.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Deepgram.AutoSDKHttpResponse<global::Deepgram.GrantV1Response>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Deepgram.GrantV1Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Deepgram.GrantV1Response> GrantAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Deepgram.GrantV1Request
            {
