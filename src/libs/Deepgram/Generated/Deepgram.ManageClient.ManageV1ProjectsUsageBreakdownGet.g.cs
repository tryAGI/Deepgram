...
namespace Deepgram
{
    ...
    {
        partial void PrepareManageV1ProjectsUsageBreakdownGetArguments(
        ...
        partial void PrepareManageV1ProjectsUsageBreakdownGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            bool? version,
            string projectId);
        partial void ProcessManageV1ProjectsUsageBreakdownGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessManageV1ProjectsUsageBreakdownGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Deepgram.UsageBreakdownV1Response> ManageV1ProjectsUsageBreakdownGetAsync(
            string projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareManageV1ProjectsUsageBreakdownGetArguments(
            ...
            __pathBuilder
                ...
                .AddOptionalParameter("alternatives", alternatives?.ToString())
                .AddOptionalParameter("callback_method", callbackMethod?.ToString())
                .AddOptionalParameter("callback", callback?.ToString())
                .AddOptionalParameter("channels", channels?.ToString())
                .AddOptionalParameter("custom_intent_mode", customIntentMode?.ToString())
                .AddOptionalParameter("custom_intent", customIntent?.ToString())
                .AddOptionalParameter("custom_topic_mode", customTopicMode?.ToString())
                .AddOptionalParameter("custom_topic", customTopic?.ToString())
                .AddOptionalParameter("deployment", deployment?.ToValueString())
                .AddOptionalParameter("detect_entities", detectEntities?.ToString())
                .AddOptionalParameter("detect_language", detectLanguage?.ToString())
                .AddOptionalParameter("diarize", diarize?.ToString())
                .AddOptionalParameter("dictation", dictation?.ToString())
                ...
                .AddOptionalParameter("filler_words", fillerWords?.ToString())
                .AddOptionalParameter("intents", intents?.ToString())
                ...
                .AddOptionalParameter("measurements", measurements?.ToString())
                .AddOptionalParameter("method", method?.ToValueString())
                .AddOptionalParameter("model", model)
                .AddOptionalParameter("multichannel", multichannel?.ToString())
                .AddOptionalParameter("numerals", numerals?.ToString())
                .AddOptionalParameter("paragraphs", paragraphs?.ToString())
                .AddOptionalParameter("profanity_filter", profanityFilter?.ToString())
                .AddOptionalParameter("punctuate", punctuate?.ToString())
                ...
                .AddOptionalParameter("sentiment", sentiment?.ToString())
                .AddOptionalParameter("smart_format", smartFormat?.ToString())
                .AddOptionalParameter("summarize", summarize?.ToString())
                .AddOptionalParameter("tag", tag)
                .AddOptionalParameter("topics", topics?.ToString())
                .AddOptionalParameter("utt_split", uttSplit?.ToString())
                .AddOptionalParameter("utterances", utterances?.ToString())
            ...
            PrepareManageV1ProjectsUsageBreakdownGetRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessManageV1ProjectsUsageBreakdownGetResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessManageV1ProjectsUsageBreakdownGetResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::Deepgram.UsageBreakdownV1Response.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Deepgram.UsageBreakdownV1Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
