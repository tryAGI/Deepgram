...
namespace Deepgram
{
    ...
    {
        partial void PrepareReadV1TextAnalyzeArguments(
        ...
        partial void PrepareReadV1TextAnalyzeRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? language,
            global::Deepgram.ReadV1Request request);
        partial void ProcessReadV1TextAnalyzeResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReadV1TextAnalyzeResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Deepgram.ReadV1Response> ReadV1TextAnalyzeAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReadV1TextAnalyzeArguments(
            ...
            PrepareReadV1TextAnalyzeRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessReadV1TextAnalyzeResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessReadV1TextAnalyzeResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ReadV1TextAnalyzeAsync(
                callback: callback,
                callbackMethod: callbackMethod,
                sentiment: sentiment,
                summarize: summarize,
