...
namespace Deepgram
{
    public partial class MediaClient
    {
        ...
        private static readonly global::Deepgram.AutoSDKServer[] s_TranscribeWithBytesServers = new global::Deepgram.AutoSDKServer[]
        ...
        private static readonly global::Deepgram.EndPointSecurityRequirement s_TranscribeWithBytesSecurityRequirement0 =
        ...
        private static readonly global::Deepgram.EndPointSecurityRequirement[] s_TranscribeWithBytesSecurityRequirements =
            new global::Deepgram.EndPointSecurityRequirement[]
            {                s_TranscribeWithBytesSecurityRequirement0,
            };
        partial void PrepareTranscribeWithBytesArguments(
        ...
        partial void PrepareTranscribeWithBytesRequest(
            ...
            bool? mipOptOut,
            byte[] request);
        partial void ProcessTranscribeWithBytesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTranscribeWithBytesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Deepgram.ListenV1MediaTranscribeResponse200> TranscribeWithBytesAsync(
        ...
        {
            var __response = await TranscribeWithBytesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Deepgram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Deepgram.AutoSDKHttpResponse<global::Deepgram.ListenV1MediaTranscribeResponse200>> TranscribeWithBytesAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTranscribeWithBytesArguments(
            ...
            var __authorizations = global::Deepgram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TranscribeWithBytesSecurityRequirements,
                operationName: "TranscribeWithBytesAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Deepgram.PathBuilder(
                                ...
                                servers: s_TranscribeWithBytesServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTranscribeWithBytesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Deepgram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Deepgram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TranscribeWithBytes",
                                methodName: "TranscribeWithBytesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTranscribeWithBytesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Deepgram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::Deepgram.ApiException<global::Deepgram.ListenV1Response>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTranscribeWithBytesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
