...
{
    /// <inheritdoc />
    public class ChannelsAgentV1MessagesAgentV1UpdateThinkThinkJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Deepgram.Realtime.ChannelsAgentV1MessagesAgentV1UpdateThinkThink>
    {
        /// <inheritdoc />
        public override global::Deepgram.Realtime.ChannelsAgentV1MessagesAgentV1UpdateThinkThink Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::System.Collections.Generic.IList<global::Deepgram.Realtime.ThinkSettingsV1>? channelsAgentV1MessagesAgentV1UpdateThinkThink1 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        channelsAgentV1MessagesAgentV1UpdateThinkThink1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (thinkSettingsV1 == null && channelsAgentV1MessagesAgentV1UpdateThinkThink1 == null)
            {
                try
                {
            ...
            var __value = new global::Deepgram.Realtime.ChannelsAgentV1MessagesAgentV1UpdateThinkThink(
                thinkSettingsV1,
        ...
        public override void Write(
            ...
            global::Deepgram.Realtime.ChannelsAgentV1MessagesAgentV1UpdateThinkThink value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
