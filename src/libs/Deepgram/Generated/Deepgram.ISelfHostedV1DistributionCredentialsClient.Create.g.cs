...
namespace Deepgram
{
    public partial interface ISelfHostedV1DistributionCredentialsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Deepgram.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Deepgram.AutoSDKHttpResponse<global::Deepgram.CreateProjectDistributionCredentialsV1Response>> CreateAsResponseAsync(
            string projectId,
