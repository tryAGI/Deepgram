                    ...
                    await global::Deepgram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Deepgram.AgentVariableV1.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Deepgram.AgentVariableV1.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
