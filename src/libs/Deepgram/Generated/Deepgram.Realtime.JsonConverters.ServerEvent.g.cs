...
{
    /// <inheritdoc />
    public class ServerEventJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Deepgram.Realtime.ServerEvent>
    {
        /// <inheritdoc />
        public override global::Deepgram.Realtime.ServerEvent Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Deepgram.Realtime.ServerEventDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Deepgram.Realtime.ServerEventDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Deepgram.Realtime.ServerEventDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Deepgram.Realtime.ResultsPayload? results = default;
            if (discriminator?.Type == global::Deepgram.Realtime.ServerEventDiscriminatorType.Results)
            {
            ...
            if (discriminator?.Type == global::Deepgram.Realtime.ServerEventDiscriminatorType.Metadata)
            {
            ...
            if (discriminator?.Type == global::Deepgram.Realtime.ServerEventDiscriminatorType.UtteranceEnd)
            {
            ...
            if (discriminator?.Type == global::Deepgram.Realtime.ServerEventDiscriminatorType.SpeechStarted)
            {
            ...
            var __value = new global::Deepgram.Realtime.ServerEvent(
                discriminator?.Type,
                results,
        ...
        public override void Write(
            ...
            global::Deepgram.Realtime.ServerEvent value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
