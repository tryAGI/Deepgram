...
namespace Deepgram.Realtime
{
    public sealed partial class DeepgramListenV1RealtimeClient
    {
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::Deepgram.Realtime.ListenV1ServerEvent> ReceiveUpdatesAsync(
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            while (_clientWebSocket.State == global::System.Net.WebSockets.WebSocketState.Open)
            {
                ...
                string json = global::System.Text.Encoding.UTF8.GetString(__messageBuffer.ToArray());
                    global::Deepgram.Realtime.ListenV1ServerEvent @event;
                    try
                    {
                        @event = (global::Deepgram.Realtime.ListenV1ServerEvent)global::System.Text.Json.JsonSerializer.Deserialize(json, typeof(global::Deepgram.Realtime.ListenV1ServerEvent), JsonSerializerContext)!;
                    }
            ...
            string rawText)
        {
            ...
            MessageReceived?.Invoke(
                this,
                new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.ListenV1ServerEvent>(
                    @event,
                    rawText,
                    json));
            ...
            if (@event.ListenV1ListenV1Results is { } __ListenV1ResultsReceived)
            {
                ListenV1ResultsReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.ListenV1ListenV1Results>(
                        __ListenV1ResultsReceived,
                        rawText,
                        json));
            }
            if (@event.ListenV1ListenV1Metadata is { } __ListenV1MetadataReceived)
            {
                ListenV1MetadataReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.ListenV1ListenV1Metadata>(
                        __ListenV1MetadataReceived,
                        rawText,
                        json));
            }
            if (@event.ListenV1ListenV1UtteranceEnd is { } __ListenV1UtteranceEndReceived)
            {
                ListenV1UtteranceEndReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.ListenV1ListenV1UtteranceEnd>(
                        __ListenV1UtteranceEndReceived,
                        rawText,
                        json));
            }
            if (@event.ListenV1ListenV1SpeechStarted is { } __ListenV1SpeechStartedReceived)
            {
                ListenV1SpeechStartedReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.ListenV1ListenV1SpeechStarted>(
                        __ListenV1SpeechStartedReceived,
                        rawText,
                        json));
            }
        }
