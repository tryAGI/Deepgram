...
namespace Deepgram.Realtime
{
    ...
    public sealed partial class AgentV1AgentV1SendFunctionCallResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Deepgram.Realtime.JsonConverters.AgentV1AgentV1SendFunctionCallResponseTypeJsonConverter))]
        public global::Deepgram.Realtime.AgentV1AgentV1SendFunctionCallResponseType Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentV1AgentV1SendFunctionCallResponse" /> class.
        /// </summary>
        /// <param name="name">
        /// The name of the function being called
        /// </param>
...
#endif
        public AgentV1AgentV1SendFunctionCallResponse(
            string name,
            string content,
            global::Deepgram.Realtime.AgentV1AgentV1SendFunctionCallResponseType type,
            string? id)
        {
            this.Type = type;
            this.Id = id;
