...
namespace Deepgram.Realtime
{
    public sealed partial class DeepgramVsRealtimeClient
    {
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::Deepgram.Realtime.VsServerEvent> ReceiveUpdatesAsync(
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            while (_clientWebSocket.State == global::System.Net.WebSockets.WebSocketState.Open)
            {
                ...
                string json = global::System.Text.Encoding.UTF8.GetString(__messageBuffer.ToArray());
                    global::Deepgram.Realtime.VsServerEvent @event;
                    try
                    {
                        @event = (global::Deepgram.Realtime.VsServerEvent)global::System.Text.Json.JsonSerializer.Deserialize(json, typeof(global::Deepgram.Realtime.VsServerEvent), JsonSerializerContext)!;
                    }
            ...
            string rawText)
        {
            ...
            MessageReceived?.Invoke(
                this,
                new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.VsServerEvent>(
                    @event,
                    rawText,
                    json));

            if (@event.SpeakV2SpeakV2Audio is { } __SpeakV2AudioReceived)
            {
                SpeakV2AudioReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<byte[]>(
                        __SpeakV2AudioReceived,
                        rawText,
                        json));
            }
            if (@event.SpeakV2SpeakV2Connected is { } __SpeakV2ConnectedReceived)
            {
                SpeakV2ConnectedReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.SpeakV2SpeakV2Connected>(
                        __SpeakV2ConnectedReceived,
                        rawText,
                        json));
            }
            if (@event.SpeakV2SpeakV2SpeechStarted is { } __SpeakV2SpeechStartedReceived)
            {
                SpeakV2SpeechStartedReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.SpeakV2SpeakV2SpeechStarted>(
                        __SpeakV2SpeechStartedReceived,
                        rawText,
                        json));
            }
            if (@event.SpeakV2SpeakV2SpeechMetadata is { } __SpeakV2SpeechMetadataReceived)
            {
                SpeakV2SpeechMetadataReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.SpeakV2SpeakV2SpeechMetadata>(
                        __SpeakV2SpeechMetadataReceived,
                        rawText,
                        json));
            }
            if (@event.SpeakV2SpeakV2Flushed is { } __SpeakV2FlushedReceived)
            {
                SpeakV2FlushedReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.SpeakV2SpeakV2Flushed>(
                        __SpeakV2FlushedReceived,
                        rawText,
                        json));
            }
            if (@event.SpeakV2SpeakV2SessionMetadata is { } __SpeakV2SessionMetadataReceived)
            {
                SpeakV2SessionMetadataReceived?.Invoke(
                    this,
            ...
            if (@event.SpeakV2SpeakV2Warning is { } __SpeakV2WarningReceived)
            {
                SpeakV2WarningReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.SpeakV2SpeakV2Warning>(
                        __SpeakV2WarningReceived,
                        rawText,
                        json));
            }
            if (@event.SpeakV2SpeakV2Error is { } __SpeakV2ErrorReceived)
            {
                SpeakV2ErrorReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.SpeakV2SpeakV2Error>(
                        __SpeakV2ErrorReceived,
                        rawText,
                        json));
            }
        }
