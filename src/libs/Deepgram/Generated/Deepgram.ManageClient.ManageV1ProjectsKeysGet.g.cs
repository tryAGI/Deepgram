...
namespace Deepgram
{
    ...
    {
        partial void PrepareManageV1ProjectsKeysGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string keyId);
        partial void PrepareManageV1ProjectsKeysGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string keyId);
        partial void ProcessManageV1ProjectsKeysGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessManageV1ProjectsKeysGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Deepgram.GetProjectKeyV1Response> ManageV1ProjectsKeysGetAsync(
            string projectId,
            string keyId,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareManageV1ProjectsKeysGetArguments(
            ...
            PrepareManageV1ProjectsKeysGetRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessManageV1ProjectsKeysGetResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessManageV1ProjectsKeysGetResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
