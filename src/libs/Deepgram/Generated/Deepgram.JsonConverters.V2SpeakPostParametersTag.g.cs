...
{
    /// <inheritdoc />
    public class V2SpeakPostParametersTagJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Deepgram.V2SpeakPostParametersTag>
    {
        /// <inheritdoc />
        public override global::Deepgram.V2SpeakPostParametersTag Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            string? v2SpeakPostParametersTagVariant1 = default;
            global::System.Collections.Generic.IList<string>? v2SpeakPostParametersTagVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        v2SpeakPostParametersTagVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        v2SpeakPostParametersTagVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (v2SpeakPostParametersTagVariant1 == null && v2SpeakPostParametersTagVariant2 == null)
            {
                try
                {
            ...
            var __value = new global::Deepgram.V2SpeakPostParametersTag(
        ...
        public override void Write(
            ...
            global::Deepgram.V2SpeakPostParametersTag value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsV2SpeakPostParametersTagVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(string), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<string?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(string).Name}");
