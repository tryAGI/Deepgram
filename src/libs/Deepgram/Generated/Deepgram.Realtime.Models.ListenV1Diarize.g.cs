...
{
    /// <summary>
    /// Deprecated. Use `diarize_model` instead. Defaults to `false`. Recognize speaker changes. Each word in the transcript will be assigned a speaker number starting at 0<br/>
    /// Default Value: false
    /// </summary>
