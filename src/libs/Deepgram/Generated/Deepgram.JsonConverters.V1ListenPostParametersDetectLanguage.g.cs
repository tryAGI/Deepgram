...
{
    /// <inheritdoc />
    public class V1ListenPostParametersDetectLanguageJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Deepgram.V1ListenPostParametersDetectLanguage>
    {
        /// <inheritdoc />
        public override global::Deepgram.V1ListenPostParametersDetectLanguage Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            bool? v1ListenPostParametersDetectLanguageVariant1 = default;
            global::System.Collections.Generic.IList<string>? v1ListenPostParametersDetectLanguageVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        v1ListenPostParametersDetectLanguageVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        v1ListenPostParametersDetectLanguageVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (v1ListenPostParametersDetectLanguageVariant1 == null && v1ListenPostParametersDetectLanguageVariant2 == null)
            {
                try
                {
            ...
            var __value = new global::Deepgram.V1ListenPostParametersDetectLanguage(
        ...
        public override void Write(
            ...
            global::Deepgram.V1ListenPostParametersDetectLanguage value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsV1ListenPostParametersDetectLanguageVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(bool), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<bool> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(bool).Name}");
