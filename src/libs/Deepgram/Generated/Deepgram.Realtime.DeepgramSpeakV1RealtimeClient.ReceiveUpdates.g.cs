...
namespace Deepgram.Realtime
{
    public sealed partial class DeepgramSpeakV1RealtimeClient
    {
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::Deepgram.Realtime.SpeakV1ServerEvent> ReceiveUpdatesAsync(
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            while (_clientWebSocket.State == global::System.Net.WebSockets.WebSocketState.Open)
            {
                ...
                string json = global::System.Text.Encoding.UTF8.GetString(__messageBuffer.ToArray());
                    global::Deepgram.Realtime.SpeakV1ServerEvent @event;
                    try
                    {
                        @event = (global::Deepgram.Realtime.SpeakV1ServerEvent)global::System.Text.Json.JsonSerializer.Deserialize(json, typeof(global::Deepgram.Realtime.SpeakV1ServerEvent), JsonSerializerContext)!;
                    }
            ...
            string rawText)
        {
            ...
            MessageReceived?.Invoke(
                this,
                new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.SpeakV1ServerEvent>(
                    @event,
                    rawText,
                    json));
            ...
            if (@event.SpeakV1Metadata is { } __SpeakV1MetadataReceived)
            {
                SpeakV1MetadataReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.SpeakV1SpeakV1Metadata>(
                        __SpeakV1MetadataReceived,
                        rawText,
                        json));
            }
            if (@event.SpeakV1Flushed is { } __SpeakV1FlushedReceived)
            {
                SpeakV1FlushedReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.SpeakV1SpeakV1Flushed>(
                        __SpeakV1FlushedReceived,
                        rawText,
                        json));
            }
            if (@event.SpeakV1Cleared is { } __SpeakV1ClearedReceived)
            {
                SpeakV1ClearedReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.SpeakV1SpeakV1Cleared>(
                        __SpeakV1ClearedReceived,
                        rawText,
                        json));
            }
            if (@event.SpeakV1Warning is { } __SpeakV1WarningReceived)
            {
                SpeakV1WarningReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Deepgram.Realtime.SpeakV1SpeakV1Warning>(
                        __SpeakV1WarningReceived,
                        rawText,
                        json));
            }
        }
