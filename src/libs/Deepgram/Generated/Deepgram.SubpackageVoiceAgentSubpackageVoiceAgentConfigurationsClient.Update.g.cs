                    ...
                    await global::Deepgram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Deepgram.AgentConfigurationV1.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Deepgram.AgentConfigurationV1.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
