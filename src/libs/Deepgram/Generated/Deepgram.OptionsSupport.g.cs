...
namespace Deepgram
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Deepgram.AutoSDKRetryOptions Retry { get; set; } = new global::Deepgram.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Deepgram.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Deepgram.IAutoSDKHook>();
        ...
        public global::Deepgram.AutoSDKClientOptions AddHook(
            global::Deepgram.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Deepgram.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Deepgram.AutoSDKClientOptions UseAuthorizationProvider(
            global::Deepgram.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Deepgram.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Deepgram.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Deepgram.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Deepgram.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Deepgram.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Deepgram.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Deepgram.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Deepgram.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Deepgram.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Deepgram.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Deepgram.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Deepgram.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Deepgram.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Deepgram.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Deepgram.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Deepgram.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Deepgram.AutoSDKClientOptions clientOptions,
            global::Deepgram.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Deepgram.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Deepgram.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Deepgram.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Deepgram.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Deepgram.IAutoSDKHook, global::Deepgram.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Deepgram.AutoSDKHookContext context)
        {
