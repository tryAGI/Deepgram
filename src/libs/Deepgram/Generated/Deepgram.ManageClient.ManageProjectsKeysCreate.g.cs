...
namespace Deepgram
{
    ...
    {
        partial void PrepareManageProjectsKeysCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            global::Deepgram.CreateKeyV1Request request);
        partial void PrepareManageProjectsKeysCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            global::Deepgram.CreateKeyV1Request request);
        partial void ProcessManageProjectsKeysCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessManageProjectsKeysCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Deepgram.CreateKeyV1Response> ManageProjectsKeysCreateAsync(
            string projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareManageProjectsKeysCreateArguments(
            ...
            PrepareManageProjectsKeysCreateRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessManageProjectsKeysCreateResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessManageProjectsKeysCreateResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ManageProjectsKeysCreateAsync(
                projectId: projectId,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
