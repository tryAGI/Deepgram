...
namespace Deepgram.Realtime
{
    ...
    public sealed partial class AgentV1AgentV1ReceiveFunctionCallResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Deepgram.Realtime.JsonConverters.AgentV1AgentV1ReceiveFunctionCallResponseTypeJsonConverter))]
        public global::Deepgram.Realtime.AgentV1AgentV1ReceiveFunctionCallResponseType Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentV1AgentV1ReceiveFunctionCallResponse" /> class.
        /// </summary>
        /// <param name="name">
        /// The name of the function being called
        /// </param>
        ...
        public AgentV1AgentV1ReceiveFunctionCallResponse(
            string name,
            string content,
            global::Deepgram.Realtime.AgentV1AgentV1ReceiveFunctionCallResponseType type,
            string? id)
        {
            this.Type = type;
            this.Id = id;
