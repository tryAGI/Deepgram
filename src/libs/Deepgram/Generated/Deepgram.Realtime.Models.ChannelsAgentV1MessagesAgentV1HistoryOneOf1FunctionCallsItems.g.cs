...
namespace Deepgram.Realtime
{
    ...
    public sealed partial class ChannelsAgentV1MessagesAgentV1HistoryOneOf1FunctionCallsItems
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelsAgentV1MessagesAgentV1HistoryOneOf1FunctionCallsItems" /> class.
        /// </summary>
        /// <param name="id">
        /// Unique identifier for the function call
        /// </param>
...
#endif
        public ChannelsAgentV1MessagesAgentV1HistoryOneOf1FunctionCallsItems(
            string id,
            string name,
            bool clientSide,
            string arguments,
