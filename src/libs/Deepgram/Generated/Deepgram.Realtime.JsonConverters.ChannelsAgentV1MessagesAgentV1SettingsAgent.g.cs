...
{
    /// <inheritdoc />
    public class ChannelsAgentV1MessagesAgentV1SettingsAgentJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Deepgram.Realtime.ChannelsAgentV1MessagesAgentV1SettingsAgent>
    {
        /// <inheritdoc />
        public override global::Deepgram.Realtime.ChannelsAgentV1MessagesAgentV1SettingsAgent Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("context.messages")) __score0++;
            if (__jsonProps.Contains("greeting")) __score0++;
            if (__jsonProps.Contains("language")) __score0++;
            if (__jsonProps.Contains("listen")) __score0++;
            if (__jsonProps.Contains("listen.provider")) __score0++;
            if (__jsonProps.Contains("speak")) __score0++;
            if (__jsonProps.Contains("think")) __score0++;
            var __score1 = 0;
            var __bestScore = 0;
            var __bestIndex = -1;
            ...
            global::Deepgram.Realtime.ChannelsAgentV1MessagesAgentV1SettingsAgent0? channelsAgentV1MessagesAgentV1SettingsAgent0 = default;
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        channelsAgentV1MessagesAgentV1SettingsAgent0 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
            ...
            if (channelsAgentV1MessagesAgentV1SettingsAgent0 == null && guid == null)
            {
                try
                {
            ...
            var __value = new global::Deepgram.Realtime.ChannelsAgentV1MessagesAgentV1SettingsAgent(
        ...
        public override void Write(
            ...
            global::Deepgram.Realtime.ChannelsAgentV1MessagesAgentV1SettingsAgent value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsChannelsAgentV1MessagesAgentV1SettingsAgent0)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Deepgram.Realtime.ChannelsAgentV1MessagesAgentV1SettingsAgent0), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Deepgram.Realtime.ChannelsAgentV1MessagesAgentV1SettingsAgent0?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Deepgram.Realtime.ChannelsAgentV1MessagesAgentV1SettingsAgent0).Name}");
